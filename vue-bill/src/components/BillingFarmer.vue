            ...
            <div class="form-group">
              <div class="row" style='justify-content: space-between;'>
                ...
                <div class="col-md-2">
                  ...
                  <select id="Farmers" name="farmer" v-model="selectedFarmers" required>
...
export default {
  ...
  data() {
    ...
    return {
      paymentStatus: "",
      frms: [],              // This will store the list of Agentss from the backend
  ...
  computed: {
    ...
    selectedFarmerDetails() {
      ...
      return this.frms.find(farmer => farmer.id === this.selectedFarmers);
    },
