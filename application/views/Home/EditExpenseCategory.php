                ...
                <div class="row justify-content-center align-items-center bg-light mt-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary mt-5">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="<?= base_url('index.php/Home/ExpCatgList/update_ExpenseCategories/' . $add_categories->id) ?>" method="post">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputName1">Name</label>
                                        <input type="name" class="form-control" id="exampleInputName1" placeholder="Enter Name" name="name" value="<?= $add_categories->name ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Description</label>
                                        <textarea class="form-control" rows="3" placeholder="Enter ..." name="description" value="<?= $add_categories->description ?>"></textarea>
                                    </div>
                                    <div class="form-group">
